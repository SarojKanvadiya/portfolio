    ...
    <VStack id='skills'>
        ...
        <Flex wrap="wrap" gap={1} m={6} justifyContent={"center"} display={{base:"none", md:"flex"}} >
            <Flex w={{base:"200px", md:"250px"}} bg={"teal.100"} p={{base:1,md:2}} m={{base:1,md:2}} borderRadius={"5px"} align={"center"}>
                <Image ml={5}  src='portfolio\src\assets\html.png' alt='html-logo' w={{base:"30px", sm:"40px"}}/>
                <Text pl={4} fontWeight={"bold"} fontSize={{base:"15px" , sm:"18px"}}>HTML</Text>
            </Flex>
            <Flex w={{base:"200px", md:"250px"}} bg={"teal.100"} p={{base:1,md:2}} m={{base:1,md:2}} borderRadius={"5px"} align={"center"}>
                <Image ml={5} src='portfolio\src\assets\css.png' alt='css-logo'w={{base:"30px", sm:"40px"}}/>
                <Text pl={4}  fontWeight={"bold"} fontSize={{base:"15px" , sm:"18px"}}>CSS</Text>
            </Flex>
            <Flex w={{base:"200px", md:"250px"}} bg={"teal.100"} p={{base:1,md:2}} m={{base:1,md:2}} borderRadius={"5px"} align={"center"}>
                <Image ml={5} src='portfolio\src\assets\js.png' alt='js-logo' w={{base:"30px", sm:"35px"}}/>
                <Text pl={4}  fontWeight={"bold"} fontSize={{base:"15px" , sm:"18px"}}>JavaScript</Text>
            </Flex>
            <Flex w={{base:"200px", md:"250px"}} bg={"teal.100"} p={{base:1,md:2}} m={{base:1,md:2}} borderRadius={"5px"} align={"center"}>
                <Image ml={5} src='portfolio\src\assets\nodejs.png' alt='nodejs-logo'w={{base:"40px", sm:"50px"}}/>
                <Text pl={4}  fontWeight={"bold"} fontSize={{base:"15px" , sm:"18px"}}>Node JS</Text>
            </Flex>
            <Flex w={{base:"200px", md:"250px"}} bg={"teal.100"} p={{base:1,md:2}} m={{base:1,md:2}} borderRadius={"5px"} align={"center"}>
                <Image ml={4} src='portfolio\src\assets\react.png' alt='react-logo' w={{base:"40px", sm:"50px"}}/>
                <Text pl={2} fontWeight={"bold"} fontSize={{base:"15px" , sm:"18px"}}>React</Text>
            </Flex>
            <Flex w={{base:"200px", md:"250px"}} bg={"teal.100"} p={{base:1,md:2}} m={{base:1,md:2}} borderRadius={"5px"} align={"center"}>
                <Image ml={5} src='portfolio\src\assets\redux.png' alt='redux-logo' w={{base:"30px", sm:"35px"}}/>
                <Text pl={4}  fontWeight={"bold"} fontSize={{base:"15px" , sm:"18px"}}>Redux</Text>
            </Flex>
            <Flex w={{base:"200px", md:"250px"}} bg={"teal.100"} p={{base:1,md:2}} m={{base:1,md:2}} borderRadius={"5px"} align={"center"}>
                <Image ml={5} src='portfolio\src\assets\chakra.png' alt='chakra-logo' w={{base:"25px", sm:"35px"}}/>
                <Text pl={4}  fontWeight={"bold"} fontSize={{base:"15px" , sm:"18px"}}>Chakra UI</Text>
            </Flex>
            <Flex w={{base:"200px", md:"250px"}} bg={"teal.100"} p={{base:1,md:2}} m={{base:1,md:2}} borderRadius={"5px"} align={"center"}>
                <Image ml={5} src='portfolio\src\assets\github.png' alt='github-logo'w={{base:"25px", sm:"30px"}}/>
