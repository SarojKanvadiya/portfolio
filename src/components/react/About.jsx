...
import Photo from "../../assets/sarojkanvadiya.jpg"
    ...
    <VStack p={5} id='about'>
      ...
      <Grid  templateColumns={{base:"1fr", md:"1fr 2fr"}} gap={2} m={"auto"} justifyContent={"center"} alignItems={"center"} p={{base:0, sm:5}} >
        <GridItem>
           ...
           <Center>
           <img src='/images/sarojkanvadiya.JPG' alt='sarojkanvadiya' w={{base:"100px", sm:"150px", md:"200px"}} border={"2px solid red"}/>
           </Center>
        ...
        <GridItem>
            ...
            <Center>
            <Link href='https://ibb.co/7tGDKZSD' download={'SarojKanvadiya-FrontendDeveloper(React)'}>
